...
class [%= namecamel %]ControllerTest
{
  ...
  void testDelete() throws Exception
  {
    ...
    /**
   * Test method for {@link com.[%= companylower %].[%= namelower %].controller.[%= namecamel %]Controller#ping()}.
   * 
   * @throws Exception
   */
  @Test
  void testPing() throws Exception
  {
    ...
    MvcResult result = mockMvc.perform( MockMvcRequestBuilders.get( "[%= apiName %]/ping" )
