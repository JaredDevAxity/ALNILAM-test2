package com.git.hub.commons.aspectj;
...
import com.git.hub.commons.exception.ValidationException;
import com.git.hub.commons.response.GenericResponseDto;
import com.git.hub.commons.response.HeaderDto;
...
public class JsonResponseHandlerInterceptor implements HandlerInterceptor
{
   ...
   * 
   */
  @Around("execution (* com.git.hub.controller.*.*(..))"
      + " and @annotation(com.git.hub.commons.aspectj.JsonResponseInterceptor)")
